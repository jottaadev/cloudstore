        ...
        <div className="flex flex-col items-center justify-center py-8 md:py-12 w-full">
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <SectionBadge title="Conecte Ferramentas" />
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Integração perfeita com suas ferramentas favoritas
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Oferecemos suporte a uma ampla gama de integrações para ajudá-lo a conectar suas ferramentas favoritas à nossa plataforma
                    </p>
                </div>
            </Container>
            <Container>
