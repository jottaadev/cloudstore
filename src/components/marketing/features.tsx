            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Crie conteúdo mais rápido <br /> e inteligente
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Transforme sua estratégia de mídia social com os recursos de ponta da Luro AI, projetados para otimizar sua criação de conteúdo e engajamento como nunca antes.
                    </p>
                </div>
            </Container>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full row-span-1 bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Gere ideias para o seu conteúdo com nossas ferramentas de IA para criar postagens envolventes em segundos.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                                    ...
                                    <div className="bento-card w-full relative items-center justify-center">
                                        <div className="w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                            <p className="text-base text-muted-foreground text-justify [mask-image:radial-gradient(50%_50%_at_50%_50%,#BAB3FF_0%,rgba(186,179,255,0)_90.69%)]">
                                                Usamos IA para ajudá-lo a criar conteúdo que ressoa com seu público. Nossas ferramentas são projetadas para otimizar sua criação de conteúdo e engajamento como nunca antes. Transforme sua estratégia de mídia social com os recursos de ponta da Luro AI. Alcance seu público com a mensagem certa na hora certa. Crie conteúdo mais rápido e inteligente com a Luro AI. Transforme sua estratégia de mídia social com os recursos de ponta da Luro AI. Crie conteúdo mais rápido e inteligente com a Luro AI. Transforme sua estratégia de mídia social com os recursos de ponta da Luro AI. Crie conteúdo mais rápido e inteligente com a Luro AI.
                                            </p>
                                        </div>
                            ...
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Crie imagens impressionantes com ferramentas de IA em segundos.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
                            <MagicCard particles={true} className="flex flex-col items-start w-full bg-primary/[0.08]">
                                <div className="bento-card w-full flex-row gap-6">
                                    ...
                                    <div className="flex flex-col mt-auto">
                                        ...
                                        <p className="text-sm md:text-base mt-2 text-muted-foreground">
                                            Receba sugestões de hashtags com base no seu conteúdo e público para aumentar seu alcance e engajamento.
                                        </p>
                                    </div>
                                </div>
                            </MagicCard>
